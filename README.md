...
<sub>**77 installable apps** — radio, instruments, astrology, media, games, tools. Dark is the moon's side of the portal, light is the sun's; every screen is drawn with light as the structure.</sub>
...
same contract draws the 77 icons, the store, the chrome and the diagrams on this page. It is enforced, not
