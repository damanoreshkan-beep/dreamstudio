// Where the picture comes from: the chooser (upload · camera · the last picture made in the farm) and the
// viewfinder. The same two pieces mirage carries (apps/mirage/source.js) — a third app with a photo intake
// is the signal they belong in the core's kit; until that bump this is a copy, kept byte-for-byte in shape.
...
// The chooser floats on the stage as a frost island — a solid panel would punch a hole in it.
