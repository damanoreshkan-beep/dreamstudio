...
<img src="icon.svg" width="84" height="84" alt="Відлуння">

# Відлуння

**Твій голос будь-якою мовою: запиши десять секунд, напиши фразу, почуй, як ти її кажеш.**
...
**Screens** Голос  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
