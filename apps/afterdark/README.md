...
<img src="icon.svg" width="84" height="84" alt="afterdark">

# afterdark

**Один живий техно-потік за повноекранним WebGL-рейвом і справжні 3D-танцівниці, залочені в такт — кожна у своєму танці. Одинадцять дівчат, тріо на сцені, ніч, що ніколи не світлішає, нахил для паралаксу.**
...
**Screens** Рейв  ·  **Capabilities** —  ·  **Offline** yes  ·  **Installable** yes
